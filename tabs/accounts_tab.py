...
class AccountsTab(QWidget):
    ...
    def _next(self, source_hwnd=None): self._do_next.emit(source_hwnd)
    ...
    def _next_safe(self, source_hwnd=None):
        self._chars.cycle(+1, source_hwnd=source_hwnd)
    ...
    def _show_notif(self, notif: AlertEvent):
        ...
        # Un compte exclu du cycle est exclu de TOUT : pas d'autofocus,
        # pas de bandeau de message, rien. Ignorer entièrement.
        if notif.pseudo in self._chars._excluded:
            return
